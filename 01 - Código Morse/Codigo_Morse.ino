...
void opcao_2(void)
{
  int i, chances = 3, score = 0;
  String caractere; 

  display.backlight();
  delay(100);

  while(chances != 0)    // Tem-se 3 chances para acertar qual é o símbolo que representa o código morse mostrado no Display 
  {
